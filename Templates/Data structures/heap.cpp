...
struct HEAP{
    ...
    void build(HEAP_DATA_TYPE *data,int n){
        register int i;
        tail=n;
    ...
    void insert(HEAP_DATA_TYPE data,register int pos){
        heap[pos]=data;
        up(down(pos));
		return;
    }
